...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, ExportKwhReportComponent, SideBarComponent, BarChartComponent, TenantManagementComponent, PieChartComponent, EnergyMeterManagementComponent, NotFoundComponent],
